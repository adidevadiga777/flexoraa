        ...
        <div className="flex flex-col min-h-screen bg-[#f5f0eb] font-['Inter',sans-serif]">
            ...
            <div className="flex flex-1">
                ...
                <div className="flex flex-col justify-between w-full lg:w-[45%] px-10 py-10 lg:px-16">
                    ...
                    {/* top spacer so form content stays vertically centered */}
                    <div />
                    ...
                    <div className="w-full max-w-[360px] mx-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-[#1a1a1a] hover:bg-[#333] text-white text-[14px] font-semibold rounded-lg py-2.5 transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
                            >
                                {loading ? (
                        ...
                        <p className="mt-6 text-center text-[13px] text-[#6b6b6b]">
                            ...
                            <Link to="/register" className="text-[#1a1a1a] font-semibold underline underline-offset-2 hover:opacity-70 transition-opacity">
                                Sign up
                            </Link>
                        </p>
                    </div>
